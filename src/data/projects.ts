export const projects = [
  {
    url: "https://setlinn.com",
    image: "setlinn.png",
    name: "Setlinn",
    tools:
      "MongoDB, NextJS, NodeJS, Git, Linux, AmazonS3, React, Bootstrap, Sass",
    description:
  ...
  },
  {
    ...
    image: "cfl.png",
    name: "Cofounderslab",
    tools: "React, NextJS, NodeJS, Git, MongoDB, Heroku, Vercel, TailwindCSS",
    description:
  ...
  {
    url: "https://dishplug.com",
    image: "food.png",
    name: "Dishplug",
    tools: "React, NextJS, NodeJS, MongoDB, Firebase, Vercel, Bootstrap, Sass",
    description:
  ...
  {
    url: "https://ms-christmas-food-21.vercel.app",
    image: "mschristmas.png",
    tools: "React, NextJS, GSAP, CSS",
    name: "MS Christmas",
    description:
